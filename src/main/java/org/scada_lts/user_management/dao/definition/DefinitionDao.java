...
/**
 * Interface responsible for writing and reading data (Definition) in the database
 *
...
public interface DefinitionDao<T> {
    ...
    /**
     * Delete the Definition object
     * @param elm
     */
    void delete(T elm);

    /**
     * Gets on ACL object based on id
     * @param id
     * @return
     */
    T get(Long id);
    ...
    /**
     * Get all objects of a particular <T> Definition class
     * @return
     */
    List<T> getAll();
}
